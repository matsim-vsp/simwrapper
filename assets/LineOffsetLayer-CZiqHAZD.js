import{g as i}from"./index-BSRT1qCd.js";import{L as r}from"./line-layer-DgyDN9oA.js";const s=`#define SHADER_NAME line-layer-vertex-shader
...
}`,c={NONE:0,LEFT:1,RIGHT:-1};class o extends r{initializeState(e){super.initializeState(e)}getShaders(){return{...super.getShaders(),vs:s}}draw({uniforms:e}){const{offsetDirection:t}=this.props,n={...e,offsetDirection:t,bearing:i.state.viewState.bearing*Math.PI/180};super.draw({uniforms:n})}}o.layerName="LineOffsetLayer";o.defaultProps={bearing:0,offsetDirection:c.RIGHT};export{o as L,c as O};
