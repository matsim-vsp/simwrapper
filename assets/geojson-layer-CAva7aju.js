import{r as Ve,v as q,w as je,o as $e,x as Ke,y as Ze,q as Xe,z as Ye,B as Bt,E as Je,F as qe,G as gt,H as dt,U as at,I as X,J,p as $,K as wt}from"./layer-T9N9JmIf.js";import{c as Qe}from"./index-BUoHzg5-.js";function $o(n){throw new Error('Could not dynamically require "'+n+'". Please configure the dynamicRequireTargets or/and ignoreDynamicRequires option of @rollup/plugin-commonjs appropriately for this require call to work.')}const Kt=`precision highp int;
...
`,ci={name:"icon",vs:Zt,fs:Zt,uniformTypes:{sizeScale:"f32",iconsTextureDim:"vec2<f32>",sizeMinPixels:"f32",sizeMaxPixels:"f32",billboard:"f32",sizeUnits:"i32",alphaCutoff:"f32"}},ui=`#version 300 es
...
`,ke=[0,0,0,255],ji={widthUnits:"meters",widthScale:{type:"number",min:0,value:1},widthMinPixels:{type:"number",min:0,value:0},widthMaxPixels:{type:"number",min:0,value:Number.MAX_SAFE_INTEGER},jointRounded:!1,capRounded:!1,miterLimit:{type:"number",min:0,value:4},billboard:!1,_pathType:null,getPath:{type:"accessor",value:n=>n.path},getColor:{type:"accessor",value:ke},getWidth:{type:"accessor",value:1},rounded:{deprecatedFor:["jointRounded","capRounded"]}},It={enter:(n,t)=>t.length?t.subarray(t.length-n.length):n};class Wt extends q{getShaders(){return super.getShaders({vs:Hi,fs:Vi,modules:[gt,dt,Ui]})}get wrapLongitude(){return!1}getBounds(){return this.getAttributeManager()?.getBounds(["vertexPositions"])}initializeState(){this.getAttributeManager().addInstanced({vertexPositions:{size:3,vertexOffset:1,type:"float64",fp64:this.use64bitPositions(),transition:It,accessor:"getPath",update:this.calculatePositions,noAlloc:!0,shaderAttributes:{instanceLeftPositions:{vertexOffset:0},instanceStartPositions:{vertexOffset:1},instanceEndPositions:{vertexOffset:2},instanceRightPositions:{vertexOffset:3}}},instanceTypes:{size:1,type:"uint8",update:this.calculateSegmentTypes,noAlloc:!0},instanceStrokeWidths:{size:1,accessor:"getWidth",transition:It,defaultValue:1},instanceColors:{size:this.props.colorFormat.length,type:"unorm8",accessor:"getColor",transition:It,defaultValue:ke},instancePickingColors:{size:4,type:"uint8",accessor:(i,{index:o,target:s})=>this.encodePickingColor(i&&i.__source?i.__source.index:o,s)}}),this.setState({pathTesselator:new Ni({fp64:this.use64bitPositions()})})}updateState(t){super.updateState(t);const{props:e,changeFlags:i}=t,o=this.getAttributeManager();if(i.dataChanged||i.updateTriggersChanged&&(i.updateTriggersChanged.all||i.updateTriggersChanged.getPath)){const{pathTesselator:r}=this.state,a=e.data.attributes||{};r.updateGeometry({data:e.data,geometryBuffer:a.getPath,buffers:a,normalize:!e._pathType,loop:e._pathType==="loop",getGeometry:e.getPath,positionFormat:e.positionFormat,wrapLongitude:e.wrapLongitude,resolution:this.context.viewport.resolution,dataChanged:i.dataChanged}),this.setState({numInstances:r.instanceCount,startIndices:r.vertexStarts}),i.dataChanged||o.invalidateAll()}i.extensionsChanged&&(this.state.model?.destroy(),this.state.model=this._getModel(),o.invalidateAll())}getPickingInfo(t){const e=super.getPickingInfo(t),{index:i}=e,o=this.props.data;return o[0]&&o[0].__source&&(e.object=o.find(s=>s.__source.index===i)),e}disablePickingIndex(t){const e=this.props.data;if(e[0]&&e[0].__source)for(let i=0;i<e.length;i++)e[i].__source.index===t&&this._disablePickingIndex(i);else super.disablePickingIndex(t)}draw({uniforms:t}){const{jointRounded:e,capRounded:i,billboard:o,miterLimit:s,widthUnits:r,widthScale:a,widthMinPixels:l,widthMaxPixels:u}=this.props,d=this.state.model,h={jointType:Number(e),capType:Number(i),billboard:o,widthUnits:at[r],widthScale:a,miterLimit:s,widthMinPixels:l,widthMaxPixels:u};d.shaderInputs.setProps({path:h}),d.draw(this.context.renderPass)}_getModel(){const t=[0,1,2,1,4,2,1,3,4,3,5,4],e=[0,0,0,-1,0,1,1,-1,1,1,1,0];return new X(this.context.device,{...this.getShaders(),id:this.props.id,bufferLayout:this.getAttributeManager().getBufferLayouts(),geometry:new J({topology:"triangle-list",attributes:{indices:new Uint16Array(t),positions:{value:new Float32Array(e),size:2}}}),isInstanced:!0})}calculatePositions(t){const{pathTesselator:e}=this.state;t.startIndices=e.vertexStarts,t.value=e.get("positions")}calculateSegmentTypes(t){const{pathTesselator:e}=this.state;t.startIndices=e.vertexStarts,t.value=e.get("segmentTypes")}}Wt.defaultProps=ji;Wt.layerName="PathLayer";var ht={exports:{}},se;function $i(){if(se)return ht.exports;se=1,ht.exports=n,ht.exports.default=n;function n(c,f,g){g=g||2;var y=f&&f.length,v=y?f[0]*g:c.length,x=t(c,0,v,g,!0),m=[];if(!x||x.next===x.prev)return m;var _,A,w,D,F,I,V;if(y&&(x=l(c,f,x,g)),c.length>80*g){_=w=c[0],A=D=c[1];for(var k=g;k<v;k+=g)F=c[k],I=c[k+1],F<_&&(_=F),I<A&&(A=I),F>w&&(w=F),I>D&&(D=I);V=Math.max(w-_,D-A),V=V!==0?32767/V:0}return i(x,m,g,_,A,V,0),m}function t(c,f,g,y,v){var x,m;if(v===et(c,f,g,y)>0)for(x=f;x<g;x+=y)m=tt(x,c[x],c[x+1],m);else for(x=g-y;x>=f;x-=y)m=tt(x,c[x],c[x+1],m);return m&&B(m,m.next)&&(N(m),m=m.next),m}function e(c,f){if(!c)return c;f||(f=c);var g=c,y;do if(y=!1,!g.steiner&&(B(g,g.next)||S(g.prev,g,g.next)===0)){if(N(g),g=f=g.prev,g===g.next)break;y=!0}else g=g.next;while(y||g!==f);return f}function i(c,f,g,y,v,x,m){if(c){!m&&x&&P(c,y,v,x);for(var _=c,A,w;c.prev!==c.next;){if(A=c.prev,w=c.next,x?s(c,y,v,x):o(c)){f.push(A.i/g|0),f.push(c.i/g|0),f.push(w.i/g|0),N(c),c=w.next,_=w.next;continue}if(c=w,c===_){m?m===1?(c=r(e(c),f,g),i(c,f,g,y,v,x,2)):m===2&&a(c,f,g,y,v,x):i(e(c),f,g,y,v,x,1);break}}}}function o(c){var f=c.prev,g=c,y=c.next;if(S(f,g,y)>=0)return!1;for(var v=f.x,x=g.x,m=y.x,_=f.y,A=g.y,w=y.y,D=v<x?v<m?v:m:x<m?x:m,F=_<A?_<w?_:w:A<w?A:w,I=v>x?v>m?v:m:x>m?x:m,V=_>A?_>w?_:w:A>w?A:w,k=y.next;k!==f;){if(k.x>=D&&k.x<=I&&k.y>=F&&k.y<=V&&T(v,_,x,A,m,w,k.x,k.y)&&S(k.prev,k,k.next)>=0)return!1;k=k.next}return!0}function s(c,f,g,y){var v=c.prev,x=c,m=c.next;if(S(v,x,m)>=0)return!1;for(var _=v.x,A=x.x,w=m.x,D=v.y,F=x.y,I=m.y,V=_<A?_<w?_:w:A<w?A:w,k=D<F?D<I?D:I:F<I?F:I,it=_>A?_>w?_:w:A>w?A:w,ot=D>F?D>I?D:I:F>I?F:I,jt=L(V,k,f,g,y),$t=L(it,ot,f,g,y),E=c.prevZ,M=c.nextZ;E&&E.z>=jt&&M&&M.z<=$t;){if(E.x>=V&&E.x<=it&&E.y>=k&&E.y<=ot&&E!==v&&E!==m&&T(_,D,A,F,w,I,E.x,E.y)&&S(E.prev,E,E.next)>=0||(E=E.prevZ,M.x>=V&&M.x<=it&&M.y>=k&&M.y<=ot&&M!==v&&M!==m&&T(_,D,A,F,w,I,M.x,M.y)&&S(M.prev,M,M.next)>=0))return!1;M=M.nextZ}for(;E&&E.z>=jt;){if(E.x>=V&&E.x<=it&&E.y>=k&&E.y<=ot&&E!==v&&E!==m&&T(_,D,A,F,w,I,E.x,E.y)&&S(E.prev,E,E.next)>=0)return!1;E=E.prevZ}for(;M&&M.z<=$t;){if(M.x>=V&&M.x<=it&&M.y>=k&&M.y<=ot&&M!==v&&M!==m&&T(_,D,A,F,w,I,M.x,M.y)&&S(M.prev,M,M.next)>=0)return!1;M=M.nextZ}return!0}function r(c,f,g){var y=c;do{var v=y.prev,x=y.next.next;!B(v,x)&&O(v,y,y.next,x)&&W(v,x)&&W(x,v)&&(f.push(v.i/g|0),f.push(y.i/g|0),f.push(x.i/g|0),N(y),N(y.next),y=c=x),y=y.next}while(y!==c);return e(y)}function a(c,f,g,y,v,x){var m=c;do{for(var _=m.next.next;_!==m.prev;){if(m.i!==_.i&&z(m,_)){var A=Q(m,_);m=e(m,m.next),A=e(A,A.next),i(m,f,g,y,v,x,0),i(A,f,g,y,v,x,0);return}_=_.next}m=m.next}while(m!==c)}function l(c,f,g,y){var v=[],x,m,_,A,w;for(x=0,m=f.length;x<m;x++)_=f[x]*y,A=x<m-1?f[x+1]*y:c.length,w=t(c,_,A,y,!1),w===w.next&&(w.steiner=!0),v.push(b(w));for(v.sort(u),x=0;x<v.length;x++)g=d(v[x],g);return g}function u(c,f){return c.x-f.x}function d(c,f){var g=h(c,f);if(!g)return f;var y=Q(g,c);return e(y,y.next),e(g,g.next)}function h(c,f){var g=f,y=c.x,v=c.y,x=-1/0,m;do{if(v<=g.y&&v>=g.next.y&&g.next.y!==g.y){var _=g.x+(v-g.y)*(g.next.x-g.x)/(g.next.y-g.y);if(_<=y&&_>x&&(x=_,m=g.x<g.next.x?g:g.next,_===y))return m}g=g.next}while(g!==f);if(!m)return null;var A=m,w=m.x,D=m.y,F=1/0,I;g=m;do y>=g.x&&g.x>=w&&y!==g.x&&T(v<D?y:x,v,w,D,v<D?x:y,v,g.x,g.y)&&(I=Math.abs(v-g.y)/(y-g.x),W(g,c)&&(I<F||I===F&&(g.x>m.x||g.x===m.x&&p(m,g)))&&(m=g,F=I)),g=g.next;while(g!==A);return m}function p(c,f){return S(c.prev,c,f.prev)<0&&S(f.next,c,c.next)<0}function P(c,f,g,y){var v=c;do v.z===0&&(v.z=L(v.x,v.y,f,g,y)),v.prevZ=v.prev,v.nextZ=v.next,v=v.next;while(v!==c);v.prevZ.nextZ=null,v.prevZ=null,C(v)}function C(c){var f,g,y,v,x,m,_,A,w=1;do{for(g=c,c=null,x=null,m=0;g;){for(m++,y=g,_=0,f=0;f<w&&(_++,y=y.nextZ,!!y);f++);for(A=w;_>0||A>0&&y;)_!==0&&(A===0||!y||g.z<=y.z)?(v=g,g=g.nextZ,_--):(v=y,y=y.nextZ,A--),x?x.nextZ=v:c=v,v.prevZ=x,x=v;g=y}x.nextZ=null,w*=2}while(m>1);return c}function L(c,f,g,y,v){return c=(c-g)*v|0,f=(f-y)*v|0,c=(c|c<<8)&16711935,c=(c|c<<4)&252645135,c=(c|c<<2)&858993459,c=(c|c<<1)&1431655765,f=(f|f<<8)&16711935,f=(f|f<<4)&252645135,f=(f|f<<2)&858993459,f=(f|f<<1)&1431655765,c|f<<1}function b(c){var f=c,g=c;do(f.x<g.x||f.x===g.x&&f.y<g.y)&&(g=f),f=f.next;while(f!==c);return g}function T(c,f,g,y,v,x,m,_){return(v-m)*(f-_)>=(c-m)*(x-_)&&(c-m)*(y-_)>=(g-m)*(f-_)&&(g-m)*(x-_)>=(v-m)*(y-_)}function z(c,f){return c.next.i!==f.i&&c.prev.i!==f.i&&!H(c,f)&&(W(c,f)&&W(f,c)&&Z(c,f)&&(S(c.prev,c,f.prev)||S(c,f.prev,f))||B(c,f)&&S(c.prev,c,c.next)>0&&S(f.prev,f,f.next)>0)}function S(c,f,g){return(f.y-c.y)*(g.x-f.x)-(f.x-c.x)*(g.y-f.y)}function B(c,f){return c.x===f.x&&c.y===f.y}function O(c,f,g,y){var v=U(S(c,f,g)),x=U(S(c,f,y)),m=U(S(g,y,c)),_=U(S(g,y,f));return!!(v!==x&&m!==_||v===0&&R(c,g,f)||x===0&&R(c,y,f)||m===0&&R(g,c,y)||_===0&&R(g,f,y))}function R(c,f,g){return f.x<=Math.max(c.x,g.x)&&f.x>=Math.min(c.x,g.x)&&f.y<=Math.max(c.y,g.y)&&f.y>=Math.min(c.y,g.y)}function U(c){return c>0?1:c<0?-1:0}function H(c,f){var g=c;do{if(g.i!==c.i&&g.next.i!==c.i&&g.i!==f.i&&g.next.i!==f.i&&O(g,g.next,c,f))return!0;g=g.next}while(g!==c);return!1}function W(c,f){return S(c.prev,c,c.next)<0?S(c,f,c.next)>=0&&S(c,c.prev,f)>=0:S(c,f,c.prev)<0||S(c,c.next,f)<0}function Z(c,f){var g=c,y=!1,v=(c.x+f.x)/2,x=(c.y+f.y)/2;do g.y>x!=g.next.y>x&&g.next.y!==g.y&&v<(g.next.x-g.x)*(x-g.y)/(g.next.y-g.y)+g.x&&(y=!y),g=g.next;while(g!==c);return y}function Q(c,f){var g=new G(c.i,c.x,c.y),y=new G(f.i,f.x,f.y),v=c.next,x=f.prev;return c.next=f,f.prev=c,g.next=v,v.prev=g,y.next=g,g.prev=y,x.next=y,y.prev=x,y}function tt(c,f,g,y){var v=new G(c,f,g);return y?(v.next=y.next,v.prev=y,y.next.prev=v,y.next=v):(v.prev=v,v.next=v),v}function N(c){c.next.prev=c.prev,c.prev.next=c.next,c.prevZ&&(c.prevZ.nextZ=c.nextZ),c.nextZ&&(c.nextZ.prevZ=c.prevZ)}function G(c,f,g){this.i=c,this.x=f,this.y=g,this.prev=null,this.next=null,this.z=0,this.prevZ=null,this.nextZ=null,this.steiner=!1}n.deviation=function(c,f,g,y){var v=f&&f.length,x=v?f[0]*g:c.length,m=Math.abs(et(c,0,x,g));if(v)for(var _=0,A=f.length;_<A;_++){var w=f[_]*g,D=_<A-1?f[_+1]*g:c.length;m-=Math.abs(et(c,w,D,g))}var F=0;for(_=0;_<y.length;_+=3){var I=y[_]*g,V=y[_+1]*g,k=y[_+2]*g;F+=Math.abs((c[I]-c[k])*(c[V+1]-c[I+1])-(c[I]-c[V])*(c[k+1]-c[I+1]))}return m===0&&F===0?0:Math.abs((F-m)/m)};function et(c,f,g,y){for(var v=0,x=f,m=g-y;x<g;x+=y)v+=(c[m]-c[x])*(c[x+1]+c[m+1]),m=x;return v}return n.flatten=function(c){for(var f=c[0][0].length,g={vertices:[],holes:[],dimensions:f},y=0,v=0;v<c.length;v++){for(var x=0;x<c[v].length;x++)for(var m=0;m<f;m++)g.vertices.push(c[v][x][m]);v>0&&(y+=c[v-1].length,g.holes.push(y))}return g},ht.exports}var Ki=$i();const Zi=Qe(Ki),pt=Ie.CLOCKWISE,re=Ie.COUNTER_CLOCKWISE,K={};function Xi(n){if(n=n&&n.positions||n,!Array.isArray(n)&&!ArrayBuffer.isView(n))throw new Error("invalid polygon")}function st(n){return"positions"in n?n.positions:n}function Pt(n){return"holeIndices"in n?n.holeIndices:null}function Yi(n){return Array.isArray(n[0])}function Ji(n){return n.length>=1&&n[0].length>=2&&Number.isFinite(n[0][0])}function qi(n){const t=n[0],e=n[n.length-1];return t[0]===e[0]&&t[1]===e[1]&&t[2]===e[2]}function Qi(n,t,e,i){for(let o=0;o<t;o++)if(n[e+o]!==n[i-t+o])return!1;return!0}function ae(n,t,e,i,o){let s=t;const r=e.length;for(let a=0;a<r;a++)for(let l=0;l<i;l++)n[s++]=e[a][l]||0;if(!qi(e))for(let a=0;a<i;a++)n[s++]=e[0][a]||0;return K.start=t,K.end=s,K.size=i,Ee(n,o,K),s}function le(n,t,e,i,o=0,s,r){s=s||e.length;const a=s-o;if(a<=0)return t;let l=t;for(let u=0;u<a;u++)n[l++]=e[o+u];if(!Qi(e,i,o,s))for(let u=0;u<i;u++)n[l++]=e[o+u];return K.start=t,K.end=l,K.size=i,Ee(n,r,K),l}function to(n,t){Xi(n);const e=[],i=[];if("positions"in n){const{positions:o,holeIndices:s}=n;if(s){let r=0;for(let a=0;a<=s.length;a++)r=le(e,r,o,t,s[a-1],s[a],a===0?pt:re),i.push(r);return i.pop(),{positions:e,holeIndices:i}}n=o}if(!Yi(n))return le(e,0,n,t,0,e.length,pt),e;if(!Ji(n)){let o=0;for(const[s,r]of n.entries())o=ae(e,o,r,t,s===0?pt:re),i.push(o);return i.pop(),{positions:e,holeIndices:i}}return ae(e,0,n,t,pt),e}function Et(n,t,e){const i=n.length/3;let o=0;for(let s=0;s<i;s++){const r=(s+1)%i;o+=n[s*3+t]*n[r*3+e],o-=n[r*3+t]*n[s*3+e]}return Math.abs(o/2)}function ce(n,t,e,i){const o=n.length/3;for(let s=0;s<o;s++){const r=s*3,a=n[r+0],l=n[r+1],u=n[r+2];n[r+t]=a,n[r+e]=l,n[r+i]=u}}function eo(n,t,e,i){let o=Pt(n);o&&(o=o.map(a=>a/t));let s=st(n);const r=i&&t===3;if(e){const a=s.length;s=s.slice();const l=[];for(let u=0;u<a;u+=t){l[0]=s[u],l[1]=s[u+1],r&&(l[2]=s[u+2]);const d=e(l);s[u]=d[0],s[u+1]=d[1],r&&(s[u+2]=d[2])}}if(r){const a=Et(s,0,1),l=Et(s,0,2),u=Et(s,1,2);if(!a&&!l&&!u)return[];a>l&&a>u||(l>u?(e||(s=s.slice()),ce(s,0,2,1)):(e||(s=s.slice()),ce(s,2,0,1)))}return Zi(s,o,t)}class io extends Te{constructor(t){const{fp64:e,IndexType:i=Uint32Array}=t;super({...t,attributes:{positions:{size:3,type:e?Float64Array:Float32Array},vertexValid:{type:Uint16Array,size:1},indices:{type:i,size:1}}})}get(t){const{attributes:e}=this;return t==="indices"?e.indices&&e.indices.subarray(0,this.vertexCount):e[t]}updateGeometry(t){super.updateGeometry(t);const e=this.buffers.indices;if(e)this.vertexCount=(e.value||e).length;else if(this.data&&!this.getGeometry)throw new Error("missing indices buffer")}normalizeGeometry(t){if(this.normalize){const e=to(t,this.positionSize);return this.opts.resolution?ze(st(e),Pt(e),{size:this.positionSize,gridResolution:this.opts.resolution,edgeTypes:!0}):this.opts.wrapLongitude?Fi(st(e),Pt(e),{size:this.positionSize,maxLatitude:86,edgeTypes:!0}):e}return t}getGeometrySize(t){if(ue(t)){let e=0;for(const i of t)e+=this.getGeometrySize(i);return e}return st(t).length/this.positionSize}getGeometryFromBuffer(t){return this.normalize||!this.buffers.indices?super.getGeometryFromBuffer(t):null}updateGeometryAttributes(t,e){if(t&&ue(t))for(const i of t){const o=this.getGeometrySize(i);e.geometrySize=o,this.updateGeometryAttributes(i,e),e.vertexStart+=o,e.indexStart=this.indexStarts[e.geometryIndex+1]}else{const i=t;this._updateIndices(i,e),this._updatePositions(i,e),this._updateVertexValid(i,e)}}_updateIndices(t,{geometryIndex:e,vertexStart:i,indexStart:o}){const{attributes:s,indexStarts:r,typedArrayManager:a}=this;let l=s.indices;if(!l||!t)return;let u=o;const d=eo(t,this.positionSize,this.opts.preproject,this.opts.full3d);l=a.allocate(l,o+d.length,{copy:!0});for(let h=0;h<d.length;h++)l[u++]=d[h]+i;r[e+1]=o+d.length,s.indices=l}_updatePositions(t,{vertexStart:e,geometrySize:i}){const{attributes:{positions:o},positionSize:s}=this;if(!o||!t)return;const r=st(t);for(let a=e,l=0;l<i;a++,l++){const u=r[l*s],d=r[l*s+1],h=s>2?r[l*s+2]:0;o[a*3]=u,o[a*3+1]=d,o[a*3+2]=h}}_updateVertexValid(t,{vertexStart:e,geometrySize:i}){const{positionSize:o}=this,s=this.attributes.vertexValid,r=t&&Pt(t);if(t&&t.edgeTypes?s.set(t.edgeTypes,e):s.fill(1,e,e+i),r)for(let a=0;a<r.length;a++)s[e+r[a]/o-1]=0;s[e+i-1]=0}}function ue(n){return Array.isArray(n)&&n.length>0&&!Number.isFinite(n[0])}const ge=`uniform solidPolygonUniforms {
  bool extruded;
  bool isWireframe;
  float elevationScale;
} solidPolygon;
`,oo={name:"solidPolygon",vs:ge,fs:ge,uniformTypes:{extruded:"f32",isWireframe:"f32",elevationScale:"f32"}},Be=`in vec4 fillColors;
in vec4 lineColors;
...
`,Mt=192/256,fe=[],po={getIconOffsets:{type:"accessor",value:n=>n.offsets},alphaCutoff:.001,smoothing:.1,outlineWidth:0,outlineColor:{type:"color",value:[0,0,0,255]}};class Ut extends bt{getShaders(){const t=super.getShaders();return{...t,modules:[...t.modules,fo],fs:ho}}initializeState(){super.initializeState(),this.getAttributeManager().addInstanced({instanceOffsets:{size:2,accessor:"getIconOffsets"},instancePickingColors:{type:"uint8",size:3,accessor:(e,{index:i,target:o})=>this.encodePickingColor(i,o)}})}updateState(t){super.updateState(t);const{props:e,oldProps:i}=t;let{outlineColor:o}=e;o!==i.outlineColor&&(o=o.map(s=>s/255),o[3]=Number.isFinite(o[3])?o[3]:1,this.setState({outlineColor:o})),!e.sdf&&e.outlineWidth&&$.warn(`${this.id}: fontSettings.sdf is required to render outline`)()}draw(t){const{sdf:e,smoothing:i,outlineWidth:o}=this.props,{outlineColor:s}=this.state,r=o?Math.max(i,Mt*(1-o)):-1,a=this.state.model,l={buffer:Mt,outlineBuffer:r,gamma:i,enabled:!!e,outlineColor:s};if(a.shaderInputs.setProps({sdf:l}),super.draw(t),e&&o){const{iconManager:u}=this.state;u.getTexture()&&(a.shaderInputs.setProps({sdf:{...l,outlineBuffer:Mt}}),a.draw(this.context.renderPass))}}getInstanceOffset(t){return t?Array.from(t).flatMap(e=>super.getInstanceOffset(e)):fe}getInstanceColorMode(t){return 1}getInstanceIconFrame(t){return t?Array.from(t).flatMap(e=>super.getInstanceIconFrame(e)):fe}}Ut.defaultProps=po;Ut.layerName="MultiIconLayer";const rt=1e20;class yo{constructor({fontSize:t=24,buffer:e=3,radius:i=8,cutoff:o=.25,fontFamily:s="sans-serif",fontWeight:r="normal",fontStyle:a="normal",lang:l=null}={}){this.buffer=e,this.cutoff=o,this.radius=i,this.lang=l;const u=this.size=t+e*4,d=this._createCanvas(u),h=this.ctx=d.getContext("2d",{willReadFrequently:!0});h.font=`${a} ${r} ${t}px ${s}`,h.textBaseline="alphabetic",h.textAlign="left",h.fillStyle="black",this.gridOuter=new Float64Array(u*u),this.gridInner=new Float64Array(u*u),this.f=new Float64Array(u),this.z=new Float64Array(u+1),this.v=new Uint16Array(u)}_createCanvas(t){const e=document.createElement("canvas");return e.width=e.height=t,e}draw(t){const{width:e,actualBoundingBoxAscent:i,actualBoundingBoxDescent:o,actualBoundingBoxLeft:s,actualBoundingBoxRight:r}=this.ctx.measureText(t),a=Math.ceil(i),l=0,u=Math.max(0,Math.min(this.size-this.buffer,Math.ceil(r-s))),d=Math.min(this.size-this.buffer,a+Math.ceil(o)),h=u+2*this.buffer,p=d+2*this.buffer,P=Math.max(h*p,0),C=new Uint8ClampedArray(P),L={data:C,width:h,height:p,glyphWidth:u,glyphHeight:d,glyphTop:a,glyphLeft:l,glyphAdvance:e};if(u===0||d===0)return L;const{ctx:b,buffer:T,gridInner:z,gridOuter:S}=this;this.lang&&(b.lang=this.lang),b.clearRect(T,T,u,d),b.fillText(t,T,T+a);const B=b.getImageData(T,T,u,d);S.fill(rt,0,P),z.fill(0,0,P);for(let O=0;O<d;O++)for(let R=0;R<u;R++){const U=B.data[4*(O*u+R)+3]/255;if(U===0)continue;const H=(O+T)*h+R+T;if(U===1)S[H]=0,z[H]=rt;else{const W=.5-U;S[H]=W>0?W*W:0,z[H]=W<0?W*W:0}}he(S,0,0,h,p,h,this.f,this.v,this.z),he(z,T,T,u,d,h,this.f,this.v,this.z);for(let O=0;O<P;O++){const R=Math.sqrt(S[O])-Math.sqrt(z[O]);C[O]=Math.round(255-255*(R/this.radius+this.cutoff))}return L}}function he(n,t,e,i,o,s,r,a,l){for(let u=t;u<t+i;u++)pe(n,e*s+u,s,o,r,a,l);for(let u=e;u<e+o;u++)pe(n,u*s+t,1,i,r,a,l)}function pe(n,t,e,i,o,s,r){s[0]=0,r[0]=-rt,r[1]=rt,o[0]=n[t];for(let a=1,l=0,u=0;a<i;a++){o[a]=n[t+a*e];const d=a*a;do{const h=s[l];u=(o[a]-o[h]+d-h*h)/(a-h)/2}while(u<=r[l]&&--l>-1);l++,s[l]=a,r[l]=u,r[l+1]=rt}for(let a=0,l=0;a<i;a++){for(;r[l+1]<a;)l++;const u=s[l],d=a-u;n[t+a*e]=o[u]+d*d}}const vo=32,xo=[];function mo(n){return Math.pow(2,Math.ceil(Math.log2(n)))}function Po({characterSet:n,getFontWidth:t,fontHeight:e,buffer:i,maxCanvasWidth:o,mapping:s={},xOffset:r=0,yOffset:a=0}){let l=0,u=r;const d=e+i*2;for(const h of n)if(!s[h]){const p=t(h);u+p+i*2>o&&(u=0,l++),s[h]={x:u+i,y:a+l*d+i,width:p,height:d,layoutWidth:p,layoutHeight:e},u+=p+i*2}return{mapping:s,xOffset:u,yOffset:a+l*d,canvasHeight:mo(a+(l+1)*d)}}function De(n,t,e,i){let o=0;for(let s=t;s<e;s++){const r=n[s];o+=i[r]?.layoutWidth||0}return o}function Ge(n,t,e,i,o,s){let r=t,a=0;for(let l=t;l<e;l++){const u=De(n,l,l+1,o);a+u>i&&(r<l&&s.push(l),r=l,a=0),a+=u}return a}function _o(n,t,e,i,o,s){let r=t,a=t,l=t,u=0;for(let d=t;d<e;d++)if((n[d]===" "||n[d+1]===" "||d+1===e)&&(l=d+1),l>a){let h=De(n,a,l,o);u+h>i&&(r<a&&(s.push(a),r=a,u=0),h>i&&(h=Ge(n,a,l,i,o,s),r=s[s.length-1])),a=l,u+=h}return u}function Lo(n,t,e,i,o=0,s){s===void 0&&(s=n.length);const r=[];return t==="break-all"?Ge(n,o,s,e,i,r):_o(n,o,s,e,i,r),r}function Co(n,t,e,i,o,s){let r=0,a=0;for(let l=t;l<e;l++){const u=n[l],d=i[u];d?(a||(a=d.layoutHeight),o[l]=r+d.layoutWidth/2,r+=d.layoutWidth):($.warn(`Missing character: ${u} (${u.codePointAt(0)})`)(),o[l]=r,r+=vo)}s[0]=r,s[1]=a}function So(n,t,e,i,o){const s=Array.from(n),r=s.length,a=new Array(r),l=new Array(r),u=new Array(r),d=(e==="break-word"||e==="break-all")&&isFinite(i)&&i>0,h=[0,0],p=[0,0];let P=0,C=0,L=0;for(let b=0;b<=r;b++){const T=s[b];if((T===`
`||b===r)&&(L=b),L>C){const z=d?Lo(s,e,i,o,C,L):xo;for(let S=0;S<=z.length;S++){const B=S===0?C:z[S-1],O=S<z.length?z[S]:L;Co(s,B,O,o,a,p);for(let R=B;R<O;R++){a[R]-p[0]/2;const U=s[R],H=o[U]?.layoutOffsetY||0;l[R]=P+p[1]/2+H,u[R]=p[0]}P=P+p[1]*t,h[0]=Math.max(h[0],p[0])}C=L}T===`
`&&(a[C]=0,l[C]=0,u[C]=0,C++)}return h[1]=P,{x:a,y:l,rowWidth:u,size:h}}function bo({value:n,length:t,stride:e,offset:i,startIndices:o,characterSet:s}){const r=n.BYTES_PER_ELEMENT,a=e?e/r:1,l=i?i/r:0,u=o[t]||Math.ceil((n.length-l)/a),d=s&&new Set,h=new Array(t);let p=n;if(a>1||l>0){const P=n.constructor;p=new P(u);for(let C=0;C<u;C++)p[C]=n[C*a+l]}for(let P=0;P<t;P++){const C=o[P],L=o[P+1]||u,b=p.subarray(C,L);h[P]=String.fromCodePoint.apply(null,b),d&&b.forEach(d.add,d)}if(d)for(const P of d)s.add(String.fromCodePoint(P));return{texts:h,characterCount:u}}class We{constructor(t=5){this._cache={},this._order=[],this.limit=t}get(t){const e=this._cache[t];return e&&(this._deleteOrder(t),this._appendOrder(t)),e}set(t,e){this._cache[t]?(this.delete(t),this._cache[t]=e,this._appendOrder(t)):(Object.keys(this._cache).length===this.limit&&this.delete(this._order[0]),this._cache[t]=e,this._appendOrder(t))}delete(t){this._cache[t]&&(delete this._cache[t],this._deleteOrder(t))}_deleteOrder(t){const e=this._order.indexOf(t);e>=0&&this._order.splice(e,1)}_appendOrder(t){this._order.push(t)}}function wo(){const n=[];for(let t=32;t<128;t++)n.push(String.fromCharCode(t));return n}const Y={fontFamily:"Monaco, monospace",fontWeight:"normal",characterSet:wo(),fontSize:64,buffer:4,sdf:!1,cutoff:.25,radius:12,smoothing:.1},ye=1024,ve=.9,xe=1.2,Ne=3;let St=new We(Ne);function To(n,t){let e;typeof t=="string"?e=new Set(Array.from(t)):e=new Set(t);const i=St.get(n);if(!i)return e;for(const o in i.mapping)e.has(o)&&e.delete(o);return e}function Ao(n,t){for(let e=0;e<n.length;e++)t.data[4*e+3]=n[e]}function me(n,t,e,i){n.font=`${i} ${e}px ${t}`,n.fillStyle="#000",n.textBaseline="alphabetic",n.textAlign="left"}function Io(n){$.assert(Number.isFinite(n)&&n>=Ne,"Invalid cache limit"),St=new We(n)}class Eo{constructor(){this.props={...Y}}get atlas(){return this._atlas}get mapping(){return this._atlas&&this._atlas.mapping}get scale(){const{fontSize:t,buffer:e}=this.props;return(t*xe+e*2)/t}setProps(t={}){Object.assign(this.props,t),this._key=this._getKey();const e=To(this._key,this.props.characterSet),i=St.get(this._key);if(i&&e.size===0){this._atlas!==i&&(this._atlas=i);return}const o=this._generateFontAtlas(e,i);this._atlas=o,St.set(this._key,o)}_generateFontAtlas(t,e){const{fontFamily:i,fontWeight:o,fontSize:s,buffer:r,sdf:a,radius:l,cutoff:u}=this.props;let d=e&&e.data;d||(d=document.createElement("canvas"),d.width=ye);const h=d.getContext("2d",{willReadFrequently:!0});me(h,i,s,o);const{mapping:p,canvasHeight:P,xOffset:C,yOffset:L}=Po({getFontWidth:b=>h.measureText(b).width,fontHeight:s*xe,buffer:r,characterSet:t,maxCanvasWidth:ye,...e&&{mapping:e.mapping,xOffset:e.xOffset,yOffset:e.yOffset}});if(d.height!==P){const b=h.getImageData(0,0,d.width,d.height);d.height=P,h.putImageData(b,0,0)}if(me(h,i,s,o),a){const b=new yo({fontSize:s,buffer:r,radius:l,cutoff:u,fontFamily:i,fontWeight:`${o}`});for(const T of t){const{data:z,width:S,height:B,glyphTop:O}=b.draw(T);p[T].width=S,p[T].layoutOffsetY=s*ve-O;const R=h.createImageData(S,B);Ao(z,R),h.putImageData(R,p[T].x,p[T].y)}}else for(const b of t)h.fillText(b,p[b].x,p[b].y+r+s*ve);return{xOffset:C,yOffset:L,mapping:p,data:d,width:d.width,height:d.height}}_getKey(){const{fontFamily:t,fontWeight:e,fontSize:i,buffer:o,sdf:s,radius:r,cutoff:a}=this.props;return s?`${t} ${e} ${i} ${o} ${r} ${a}`:`${t} ${e} ${i} ${o}`}}const Pe=`uniform textBackgroundUniforms {
  bool billboard;
  float sizeScale;
  float sizeMinPixels;
  float sizeMaxPixels;
